...
//
//        System.out.println(
//                "Checking if QueryBuilderService works: method 'lookUpByResourceType( String tableName, Map<String,String> valuesToSearch)':"
...
//        System.out.println();
        ...
        List<GenericResource> listGenRes2 = resService.findResourcesByResourceType(sqlQuery, tableName, valuesToSearch);
