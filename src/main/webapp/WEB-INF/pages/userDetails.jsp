...
<div class="container">
    ...
    <br>
    <%--"${users.get(1).firstName}"--%>

<%--    <td>
        &lt;%&ndash;<c:forEach var="user" items="${listValue.users}">&ndash;%&gt;
            ...
            <table data-toggle="table" id="refinementRequest"
                ...
                <c:forEach var="listValue" items="${users}">
                    <tr>
                        ...
                        <td>${listValue.secondName}</td>
                        <td>${listValue.middleName}</td>
                        <td>${listValue.passportSeries}</td>
                        <td>${listValue.passportNumber}</td>
                        <td>${listValue.phone}</td>
                            <%--
                                    &lt;%&ndash;
                                    <td><c:forEach var="user" items="${listValue.users}">
                                        ${user.Username}
                                    </c:forEach>
                                    </td>&ndash;%&gt;
                                    &lt;%&ndash;<c:if test="${listValue.enabled=='true'}">
                                        <td>
                                            <div class="checkbox" >
