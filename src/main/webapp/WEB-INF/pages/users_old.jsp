...
<head>
    <title>${title}</title>
    <jsp:include page="../pages/metadata.jsp"/>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div id="resource_address_form_placeholder">
                                    ...
                                    <form class="form" id="add_user_form" action="/addUser" method="post">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label for="Email">Email</label>
                                                    <input type="email" path="user.email" class="form-control" name="email" id="Email" placeholder="example@mail.com ">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" path="user.password" class="form-control" name="password" id="Password" placeholder="Enter password">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label for="Repeat_password">Repeat password</label>
                                                    <input type="text" path="user.confirmPassword" class="form-control" name="repeat_password" id="Repeat_password" placeholder="Repeat password">
                                                </div>
                                            </div>
                                        </div>
