                ...
                <div class="container-fluid">
                    <div class="form-group">
                        ...
                        <div class="pull-right">
                            <button type="submit" id="add-props-btn" class="btn btn-primary disabled"
                                    data-dismiss="modal">Add
                            </button>
                            <button type="reset" id="cancel-btn" class="btn btn-primary" data-dismiss="modal">Cancel
                            </button>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="column-name" name="columnName"
                                       placeholder="Name"
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="units" name="units"
                                       placeholder="e.g. cubical centimeters">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="units">Units contraction</label>
                                <input type="text" class="form-control" id="units-short" name="unitsShort"
                                       placeholder="e.g. cc"
                        ...
                        <div class="col-sm-8">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="hint" name="hint"
                                       placeholder="Some hint to registrator">
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="pull-right">
                        <button type="button" id="save-btn" class="btn btn-primary" <%--data-dismiss="modal"--%>>Save
                        </button>
                        <button type="button" id="save-add-btn" class="btn btn-primary" <%--data-dismiss="modal"--%>>
                            Save/Add New
                        </button>
                    </div>
                </div>
