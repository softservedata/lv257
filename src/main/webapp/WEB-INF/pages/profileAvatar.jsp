                ...
                <form id="requestForm" action="${contextPath}/resources/request"
                    ...
                    <div class="form-group">
                        <spring:bind path="mRequest.resourceType">
                            ...
                            <input type="text" path="mRequest.resourceType" name="${status.expression}"
                                   value="${status.value}" class="form-control"
                                   placeholder="Enter new kind of resource"/>
                    ...
                    <div class="form-group">
                        <spring:bind path="mRequest.description">
                            ...
                            <input type="text" path="mRequest.description" name="${status.expression}"
                                   value="${status.value}" class="form-control" placeholder="Enter details"/>
                    ...
                    <button name="submit" type="submit" id="submit" value="Submit" class="btn btn-primary">Send
                        request
                    </button>
