...
INSERT INTO `resource` VALUES (1,100000),(2,100001),(3,100002),(4,100100);

UNLOCK TABLES;


LOCK TABLES `resource_owning` WRITE;

INSERT INTO `resource_owning` VALUES (1,100001,1,100300),(2,100001,2,100300),(3,100100,1,100300),(4,100100,3,100302),(5,100100,4,100303);
