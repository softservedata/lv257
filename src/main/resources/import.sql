...
INSERT INTO `RESOURCE_REQUEST` (`id_request`,`description`,`resourceType`,`status`,`id_document`,`id_requester`,`id_assigner`) VALUES (100100,'Street varshavska 12','House Private','DECLINED',100001,9,8);
