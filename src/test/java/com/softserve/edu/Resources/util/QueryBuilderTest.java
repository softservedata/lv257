...
//        allResProperties1.add(new ConstrainedProperty(newResourceProperty("Model")));
//        allResProperties1.add(new ConstrainedProperty(newResourceProperty("Year")));
        //
//        List<ConstrainedProperty> allResProperties2 = new ArrayList<>();
//        allResProperties2.add(new ConstrainedProperty(newResourceProperty("Model")));
      //
